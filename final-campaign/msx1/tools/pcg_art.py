...
uint8 color indices with shape (16, 192, 256). stage is 0 through 4.
Stages 0 and 4 are original coastal/dawn worlds generated by pcg_expansion_art.
...
def generate_frames(stage,source_dir,quality='high'):
    ...
    if stage in (0,4):
        from pcg_expansion_art import source_frames
        frames=_two_colors(source_frames(stage,4 if quality=='coarse' else 2))
    else:
