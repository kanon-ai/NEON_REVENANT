...
assert next_offset<=1048576, f'Compressed asset/world data exceeds ROM by {next_offset-1048576} bytes'
header=['/* Generated bank-streamable lossless LZ locations. */',
        ...
        'static const unsigned char world_banks[5]={'+','.join(map(str,world_banks))+'};',
        'static const unsigned int world_offsets[5]={'+','.join(map(str,world_offsets))+'};']
