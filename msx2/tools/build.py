...
out=ROOT.parent/'outputs/msx2';out.mkdir(parents=True,exist_ok=True)
...
assert area and int(area[1],16)+int(area[2],16)<=0xEE00, 'Game data overlaps IM2 table at EE00'
...
manifest.update({'cpu':'Z80 3.58 MHz','minimum_ram_bytes':65536,'vram_bytes':131072,
                 ...
                 'interrupts':'IM2 EE00-EF00 vector, EFEF trampoline; 60 Hz VBlank',
