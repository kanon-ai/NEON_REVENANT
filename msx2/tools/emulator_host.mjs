...
pipe.listen('\\\\.\\pipe\\'+name,()=>{
 child=spawn(process.env.OPENMSX_EXE||'C:\\Program Files\\openMSX\\openmsx.exe',['-control','pipe:'+name,'-machine','C-BIOS_MSX2_64K',...process.argv.slice(2)],{windowsHide:true,stdio:['ignore','pipe','pipe']});
