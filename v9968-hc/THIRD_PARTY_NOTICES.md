...
## V9968 HC v1.0
HC uses the same four SDCC runtime objects listed above; corresponding sources and notices are included. V9968 specification: https://github.com/hra1129 / emulator: https://buppu3.github.io/ . The minimal launcher XML selects the documented V9968_OLD profile. Emulator and BIOS binaries are not bundled.
