@echo off
setlocal
if not defined OPENMSX_EXE goto missing_emulator
...
copy /Y "%~dp0config\HRA_V9968_CURRENT.xml" "user\extensions\HRA_V9968_HC.xml" >nul
...
echo Set OPENMSX_EXE to the provisional current-spec V9968 build described in README.md.
goto failed
:missing_rom
