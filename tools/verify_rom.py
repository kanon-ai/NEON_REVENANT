...
results=[]
def cmd(s):
    r=urllib.request.Request('http://127.0.0.1:18790',data=s.encode(),method='POST')
...
check('B1-4bpp-mode',int(cmd('debug read {Sunrise GFX9000 regs} 6'))==0x81 and int(cmd('debug read {Sunrise GFX9000 regs} 13'))==0)
